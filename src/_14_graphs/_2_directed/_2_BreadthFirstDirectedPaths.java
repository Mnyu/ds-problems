...
public class _2_BreadthFirstDirectedPaths {
    private final boolean[] visited;
    private final int[] parent;
    private final int[] distTo;

    public _2_BreadthFirstDirectedPaths(_1_DirectedGraph graph, int source) {
    ...
    private void bfs(_1_DirectedGraph graph, int source) {
