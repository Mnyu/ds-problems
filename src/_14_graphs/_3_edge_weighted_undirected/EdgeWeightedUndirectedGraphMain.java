...
public class EdgeWeightedUndirectedGraphMain {
    public static void main(String[] args) {
        ...
        System.out.println("MST using Lazy Prim's Algo is :");
        System.out.println(primsAlgoForMST.getMST());
        System.out.println("MST weight using Lazy Prim's Algo = " + primsAlgoForMST.getWeight());

        _4_EagerPrimsAlgoForMST eagerPrims = new _4_EagerPrimsAlgoForMST(graph);
        System.out.println("MST using Eager Prim's Algo is :");
        System.out.println(eagerPrims.getMST());
        System.out.println("MST weight using Eager Prim's Algo = " + eagerPrims.getWeight());
